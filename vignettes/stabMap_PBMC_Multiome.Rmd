...
- Project cells from non-reference datasets onto the reference dataset embedding
 using a linear model to traverse shortest paths in the `mosaicDataTopology()`   
